<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <% String ctx=request.getContextPath(); String error=(String) request.getAttribute("error"); String success=(String)
        request.getAttribute("success"); String csrfToken=(String) request.getAttribute("csrfToken"); if
        (csrfToken==null) csrfToken=com.oceanview.util.CSRFTokenUtil.generateToken(request); String
            ...
            <div class="auth-wrapper">
                <div class="auth-card animate-fadeInUp">
                    ...
                    <div class="auth-header">
                        ...
                        <h3>Welcome Back</h3>
                        <p style="color: var(--text-muted); font-size: 0.9rem; margin-top: 4px;">Sign in to manage your
                            reservations</p>
                    </div>

                    <% if ("loggedOut".equals(msg)) { %>
                        <div class="alert-custom alert-info" data-dismiss><i class="fas fa-info-circle"></i> You have
                            been logged out.</div>
                        <% } %>
                            <% if (error !=null) { %>
                                        ...
                                        <% } %>
                                            ...
                                            <div
                                                ...
                                                <p style="color: var(--text-muted); font-size: 0.9rem;">
                                                    ...
                                                    <a href="<%= ctx %>/register.jsp" style="font-weight: 600;">Create
                                                        Account</a>
                                                </p>
                                            </div>
                </div>
